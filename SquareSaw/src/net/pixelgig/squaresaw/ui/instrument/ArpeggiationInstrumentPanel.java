	...
	KeyboardListener
{
	...
	public ArpeggiationInstrumentPanel(int x, Instrument track, Keyboard keys)
	{
		...
		arpeggiationList = new Group();
			arpeggiationList.setX(115);
			arpeggiationList.setY(166);
	...
	public void refreshArpeggiationList()
	{
		...
		{
			TextActor arpListItem = new TextActor(steps[i] + "", 0, i*-10);
			arpListItem.setX(-arpListItem.getWidth());
			arpeggiationList.addActor(arpListItem);
		}
	}

...
public class InstrumentSettings
{
	...
	final double[] DECAY_SCALE = {
			0,.00000,	.5,.00005,	.75,.0001,	.95,.0005,	1,1};
	...
	public double volume, ext_volume;
	public boolean sustain = false;
	public boolean bendPitch = false;

	public double envelopeAttack, ext_envelopeAttack;
	public double envelopeDecay, ext_envelopeDecay;
	public double envelopeSustain;
	public double envelopeRelease, ext_envelopeRelease;

	public double VLFOSpeed, ext_VLFOSpeed;
	public double VLFODepth, ext_VLFODepth;
	...
	boolean arpPostFX = false;
	boolean arpResetOnNote = true;
